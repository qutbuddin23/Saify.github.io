  ...
  const app = Vue.createApp({
        ...
        testimonialsItems: [
          {
            ...
            quoteContent: {
              en: "Saify simply provides amazing web development service. Their team is extremely professional and the easiest to meet I have ever worked with. I would recommend Saify to anyone.",
          ...
          },
          {
            imgUrl: "https://via.placeholder.com/200",
            quoteContent: {
              en: "Excellent Team to work with. Always positive to find the most appropriate solution. Saify is one of the professional web development agency that provides awesome services.",
          ...
          },
          {
            imgUrl: "https://via.placeholder.com/200",
            quoteContent: {
              en: "Saify team is very professional, always delivers high quality results, and is always there to help. Look forward to working with Saify in other projects.",
          ...
          },
          {
            imgUrl: "https://via.placeholder.com/200",
            quoteContent: {
              en: "Saify worked on a handful of projects for us and has always exceeded our expectations. Saify team is dedicated, talented and a delight to work with.",
    ...
    methods: {
      ...
      getAppTheme() {
        ...
        const storageSavedTheme = localStorage.getItem("SaifySavedTheme"); // Check to see if there a saved theme
        ...
        localStorage.setItem("SaifySavedTheme", this.savedTheme);
      },
